...
if ( ! function_exists( 'werdu_child_styles' ) ) {
    function werdu_child_styles() {
        ...
        wp_enqueue_style( 'child-style', get_stylesheet_uri(), array( 'parent-style' ), '7.7.2' );
    }
...
/* ============================================================
   3. UEBER UNS CSS CONDITIONEEL LADEN
   ============================================================ */
add_action( 'wp_enqueue_scripts', 'werdu_ueber_uns_styles', 20 );
function werdu_ueber_uns_styles() {
    if ( is_page( 'ueber-uns' ) ) {
        $css_path = get_stylesheet_directory() . '/css/ueber-uns.css';
        if ( file_exists( $css_path ) ) {
            wp_enqueue_style(
                'werdu-ueber-uns',
                get_stylesheet_directory_uri() . '/css/ueber-uns.css',
                array( 'child-style' ),
                '1.0.0',
                'all'
            );
...
/* ============================================================
   5. 301 REDIRECT: Oude /shop/ product URLs
   ============================================================ */
...
/* ============================================================
   8. FORMALE E-MAIL ANREDE (WooCommerce)
   ============================================================ */
...
// 10.1 jQuery Migrate uitschakelen
...
// 10.2 Dashicons uitschakelen voor niet-ingelogde bezoekers
add_action( 'wp_enqueue_scripts', function() {
...
// 10.4 WordPress versienummer verwijderen
remove_action( 'wp_head', 'wp_generator' );

/* ============================================================
   11. CLS FIX — font-display: swap
   ============================================================ */
...
/* ============================================================
   13. WooCommerce scripts ALLEEN op shop pagina's
   ============================================================ */
add_action( 'wp_enqueue_scripts', function() {
    if ( is_admin() ) return;
...
/* ============================================================
   14. Onnodige scripts/styles uitschakelen op startpagina
   ============================================================ */
function werdu_page_has_form() {
    if ( is_admin() ) return false;
    $form_pages = array( 'kontakt', 'beratung', 'contact', 'anfrage' );
...
add_action( 'wp_enqueue_scripts', function() {
    ...
    if ( ! is_page( 'kontakt' ) && ! is_page( 'beratung' ) ) {
...
/* ============================================================
   15. Database query cache hints
   ============================================================ */
add_filter( 'wp_cache_themes_persistently', '__return_true', 100 );

/* ============================================================
   16. Elementor: Google Fonts uitschakelen
   ============================================================ */
...
/* ============================================================
   17. WordPress heartbeat vertragen
   ============================================================ */
...
/* ============================================================
   20. Font Awesome font-display: swap
   ============================================================ */
add_action( 'wp_head', function() {
    if ( is_admin() ) return;
    echo '<style>@font-face { font-display: swap !important; }</style>' . "
...
/* ============================================================
   22. CLS FIX — Header stabiliseren
   ============================================================ */
add_action( 'wp_head', function() {
    if ( is_admin() ) return;
    echo '<style>' . "
...
/* ============================================================
   28. BARRIEREFREIHEIT — Dynamische Sitemap Shortcode
   ============================================================ */
...
/* ============================================================
   29. HOMEPAGE ASSET CLEANUP
   ============================================================ */
add_action( 'wp_enqueue_scripts', function() {
    if ( ! is_front_page() || is_admin() ) return;
    wp_dequeue_style( 'wc-blocks-style' );
    wp_dequeue_script( 'wc-cookie' );
    wp_dequeue_script( 'jquery-flexslider' );
    wp_dequeue_script( 'shoppingcart-slider' );
    wp_dequeue_script( 'jquery-sticky' );
    wp_dequeue_script( 'shoppingcart-sticky-settings' );
    wp_dequeue_script( 'shoppingcart-skip-link-focus-fix' );
    wp_dequeue_style( 'shoppingcart-style' );
}, 1000 );