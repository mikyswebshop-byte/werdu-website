...
function werdu_footer_column_markup( $n ) {
	...
	if ( 1 === $n ) :
		?>
		<ul>
			<li><a href="<?php echo esc_url( home_url( '/16-kwh-lifepo4-heimspeicher-51-2v-314ah/' ) ); ?>">16 kWh Basen Green LiFePO4 Heimspeicher</a></li>
			<li><a href="<?php echo esc_url( home_url( '/16-kwh-heimspeicher-lifepo4-solarbatterie/' ) ); ?>">16 kWh TewayCell LiFePO4 Heimspeicher</a></li>
			<li><a href="<?php echo esc_url( home_url( '/30-32-kwh-lifepo4-heimspeicher-560-628ah/' ) ); ?>">30-32 kWh TewayCell LiFePO4 Heimspeicher</a></li>
			<li><a href="<?php echo esc_url( home_url( '/32-kwh-lifepo4-heimspeicher-628ah/' ) ); ?>">32 kWh Basen Green LiFePO4 Heimspeicher</a></li>
			...
			<li><a href="<?php echo esc_url( home_url( '/heimspeicher-systeme/' ) ); ?>">LiFePO4 Batterien und Heimspeicher-Systeme</a></li>
			<li><a href="<?php echo esc_url( home_url( '/solarbatterie-rechner/' ) ); ?>">Heimspeicher Rechner</a></li>
		</ul>
		<?php
	elseif ( 2 === $n ) :
		?>
	...
	elseif ( 4 === $n ) :
		...
		<ul>
			...
			<li><a href="<?php echo esc_url( home_url( '/heimspeicher-installation/' ) ); ?>">Heimspeicher Installation</a></li>
			<li><a href="<?php echo esc_url( home_url( '/lohnt-sich-ein-heimspeicher/' ) ); ?>">Lohnt sich ein Heimspeicher?</a></li>
			<li><a href="<?php echo esc_url( home_url( '/heimspeicher-kosten-2026-preisfallen-vermeiden/' ) ); ?>">7 versteckte Preisfallen beim Heimspeicher</a></li>
