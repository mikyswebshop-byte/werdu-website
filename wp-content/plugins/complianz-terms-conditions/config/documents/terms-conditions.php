<?php
/**
 * Terms and Conditions document configuration.
 *
 * Defines the document structure, sections, and content elements for the
 * Terms and Conditions legal document. Each section maps to a wizard question
 * and contains conditional content blocks rendered by the document class.
 *
...
$this->pages['all']['terms-conditions']['document_elements'] = array(
	...
	array(
		...
		'content' => _x( 'By registering with, accessing, or otherwise using this website, you hereby agree to be bound by these Terms and conditions set forth below.', 'Legal document', 'complianz-terms-conditions' ) . '&nbsp;' .
					...
					_x(
						'In some particular cases, we can also ask you to explicitly agree.',
						'Legal document',
	...
	array(
		...
		'content'            => sprintf(
			...
			_x(
				'The content on this website is available under a %s License, unless specified otherwise.',
				'Legal document',
				'complianz-terms-conditions'
			),
			'[about_copyright]'
	...
	array(
		...
		'content'   => sprintf( _x( 'Except to the extent any additional contract expressly states otherwise, our maximum liability to you for all damages arising out of or related to the website or any products and services marketed or sold through the website, regardless of the form of legal action that imposes liability (whether in contract, equity, negligence, intended conduct, tort or otherwise) will be limited to %s.', 'Legal document', 'complianz-terms-conditions' ), '[about_liability]' ) . '&nbsp;' .
					_x( 'Such limit will apply in the aggregate to all of your claims, actions and causes of action of every kind and nature.', 'Legal document', 'complianz-terms-conditions' ),
		'condition' => array( 'max_liability' => 'yes' ), // Fixed amount.
	),
	...
	array(
		'content'   => _x( 'We have developed a policy to address any privacy concerns you may have.', 'Legal document', 'complianz-terms-conditions' ) . '&nbsp;' .
					sprintf(
						...
						_x(
							'For more information, please see our %1$sPrivacy Statement%2$s and our %3$sCookie Policy%4$s.',
							'Legal document',
							'complianz-terms-conditions'
						),
						'[privacy_policy]',
	...
	array(
		...
		'content'   => sprintf( _x( 'These Terms and Conditions, together with our %1$sprivacy statement%2$s and %3$scookie policy%4$s, constitute the entire agreement between you and %5$s in relation to your use of this website.', 'Legal document', 'complianz-terms-conditions' ), '[privacy_policy]', '</a>', '[cookie_policy]', '</a>', '[organisation_name]' ),
		'condition' => array( 'legal_mention' => 'yes' ),
	),
	...
	array(
		...
		'content'   => sprintf( _x( 'You may contact us regarding these Terms and Conditions through our %1$scontact%2$s page.', 'Legal document', 'complianz-terms-conditions' ), '[page_company]', '[/page_company]' ),
		'condition' => array(
	...
	array(
		...
		'content' => sprintf( _x( 'You can also %1$sdownload%2$s our Terms and Conditions as a PDF.', 'Legal document', 'complianz-terms-conditions' ), '<a href="[download_pdf_link]">', '</a>' ),
	),
