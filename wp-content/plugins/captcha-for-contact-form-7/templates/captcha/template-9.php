...
?>
<div class="f12-captcha template-9">
    <div class="c-header">
        <!-- Captcha data in bordered dark box -->
        <div class="c-data" aria-live="polite" aria-atomic="true" aria-describedby="captcha-instructions-9">
    ...
    <div class="<?php echo esc_attr( $wrapper_classes ); ?>" <?php echo $wrapper_attributes; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Pre-escaped at construction. ?>>
        <input class="f12c <?php echo esc_attr( $classes ); ?>"
               ...
               value=""
               aria-required="true"
               aria-describedby="captcha-instructions-9"/>
    </div>

    <!-- Screen reader instructions -->
    <p id="captcha-instructions-9" class="screen-reader-text">
